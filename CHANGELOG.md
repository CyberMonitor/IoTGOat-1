IOTGOAT VULNERABLE WEB APPLICATION
=======================

v1.9-rev04 (2015-10-29)
======
+ Remove menu captcha (@firebitsbr)
+ Remove menu PHPIDS (@firebitsbr)
+ Added links about IoTs (OWASP IOT)(@firebitsbr)
