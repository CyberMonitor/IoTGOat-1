...
<div class=\"body_padded\">
	...
	<p>IoTGOAT is a PHP/MySQL web application that is damn vulnerable for IoT (Internet of Things). Its main goals are to be an aid for security professionals to test their skills and tools in a legal environment, help web developers better understand the processes of securing web applications and aid teachers/students to teach/learn web application security in a class room environment</p>
	<p>IoTGOAT is fork DVWA is a RandomStorm OpenSource project. All material is copyright 2008-2015 RandomStorm & Ryan Dewhurst, but change forks is copyright 2015 Mauro Risonho de Paula Assumpção.</p>
