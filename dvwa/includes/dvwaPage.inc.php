...
function &dvwaPageNewGrab() {
	$returnArray = array(
		'title'           => 'IoTGOAT - Internet of Things - Web Application Vulnerable v' . dvwaVersionGet() . '',
		'title_separator' => ' :: ',
		'body'            => '',
		'page_id'         => '',
		'help_button'     => '',
...
function dvwaHtmlEcho( $pPage ) {
	...
	if( dvwaIsLoggedIn() ) {
		$menuBlocks[ 'meta' ][] = array( 'id' => 'security', 'name' => 'IoTGOAT Security', 'url' => 'security.php' );
	...
	<body class=\"home\">
		<div id=\"container\">
			...
			<div id=\"footer\">
				...
				<p>IoTGOAT - Internet of Things - Web Application Vulnerable v" . dvwaVersionGet() . "</p>
