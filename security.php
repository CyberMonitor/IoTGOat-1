...
$page[ 'title' ]   = 'IoTGoat Security' . $page[ 'title_separator' ].$page[ 'title' ];
...
<div class=\"body_padded\">
	<h1>IoTGOAT Security <img src=\"" . DVWA_WEB_PAGE_TO_ROOT . "dvwa/images/lock.png\" /></h1>
	<br />
	...
	<form action=\"#\" method=\"POST\">
		{$securityLevelHtml}
		<p>You can set the security level to low, medium, high or impossible. The security level changes the vulnerability level of IoTGOAT:</p>
		<ol>
			...
			<li> Impossible - This level should be <em>secure against all vulnerabilities</em>. It is used to compare the vulnerable source code to the secure source code.<br />
				Priority to IoTGOAT v1.9, this level was known as 'high'.</li>
		</ol>
